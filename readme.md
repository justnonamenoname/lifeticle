...
3) Particles are quantumly entangled with each other, and the electrical activity around them creates qualia in them, which is felt by the lifeticle connected to them.
...
Orch OR:  
Solution the binding problem: No model of qualia signal convergence or central processing area for signals, but does not contradict the problem's resolution
