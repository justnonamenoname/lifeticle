...
Значит из частиц что-то остаётся, и какая та - и есть центральная/основная в мозге, и она и является т.н. наблюдателем (лайфтиклом).
Ты в мозге - частица что чувствует - т.н. наблюдатель/лайфтикл.
...
Если лайфтиклов в мозге много, то может оказаться, что не определить который был основным и жил (другие в этом случае были не активны).
...
Получается, в мозге есть определение на каком расстоянии и расположении находится боль.
...
Сложнее чтобы лайфтикл оказался в мозге при эволюционном развитии, но если бы он был в атоме, то эта дополнительная сложность не нужна.
...
Идея множественного сознания, когда лайфтиклов в мозге много и они чувствуют одно и то же, требует, чтобы одинаковые квалиа генерировались для нескольких лайфтиклов.
