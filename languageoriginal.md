...
При этом только информация не могла бы создавать боль, она, например, может задаваться спином.
...
Для корректности теории информация должна передаваться на квантовый уровень
