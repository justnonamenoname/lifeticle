...
Значения +-  
CEMI:
1) Ограничение связывания скоростью света
2) Отсутствие определения границы
5) Отсутствие физического влияния в зависимости от версии и нарушение закона сохранения энергии в случае влияния

Orch OR:
2) Нет модели схождения сигналов квалиа или центрального отдела для сигналов, но не противоречит решению проблемы связывания
