...
Если крионировать умершего не удалось, при кремации прах можно выкинуть либо на землю или кладбище, либо в море.
...
Однако лайфтикл, возможно, улетает при сожжении в дыме, что создаёт неоднозначность в рекомендации.
...
Ответ на вопрос, чем является лайфтикл и как генерируются квалиа, ответит на вопрос живые ли вирусы или биороботы.
...
Идея более сложна с позиции структуры мозга, эволюционно и с учётом обратного влияния лайфтикла.
