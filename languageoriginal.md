...
Физическое явление приводит к квалиа, физики могут начать предполагать каким явлением может оно быть.
...
При этом слой изображения не выглядит как что-то занимающее объём, будто есть 2 параметра размера - высота и ширина, а 3-й параметр глубины отсутствует.
...
Если крионировать умершего не удалось, при кремации прах можно выкинуть либо на кладбище, либо в море.
