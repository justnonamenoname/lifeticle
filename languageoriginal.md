...
однако нарушение теоремы в этом не обязательно, т.к. оба лайфтикла были частью волновой функции.
Кроме этого, если квалиа объект создаётся из квантового состояния, то проблемы также может не возникать.
