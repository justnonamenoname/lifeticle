...
Без законов квантовой механики можно предположить, что зрительный образ нарушает принцип локальности, т.к. точки отображаются одновременно.
...
|ψ<sub>qualia</sub>⟩ = ∑<sub>i,j,...</sub>cij...(|зрение<sub>i</sub>⟩⊗|звук<sub>j</sub>⟩⊗...)

Зрение

|ψ<sub>зрение</sub>⟩ = i[1,N]∑энергия<sub>i</sub>⋅|цвет<sub>i</sub>⟩⊗|2д координата<sub>i</sub>⟩⊗|размер<sub>i</sub>⟩⊗|расстояние<sub>i</sub>⟩⊗...

Уровень яркость зависит от уровня энергии

|цвет⟩ = красный|диапозон красного⟩+зелёный|диапозон зелёного⟩+синий|диапозон синего⟩+...

Точные формулы можно определить только изучая генератор квалиа.  
