...
2) Частицы квантово связаны между собой, и электрическая активность вокруг них и создают в них квалиа, что и чувствует основная частица квантово связанная с ними.
Это создаёт проблему расстояния.
Метод соответсвует теории Пенроуза-Хамероффа.
3) У лайфтикла своё поле.
К проблеме расстояния добавляется непонятная сущность, и должен определяться размер поля.
Метод соответсвует теории CEMI.
