...
У т.н. наблюдателя уже, до своего рождения, было состояние смерти, и всё же он родился.
...
Если бы невозможно было родиться 2й раз - невозможно было бы и 1й.
...
Самое близкое описание, того чем вызываются квалиа - электрическая активность вокруг центральной частицы.
...
Проблема точечной связности также указывает на фундаментальность квалиа.
...
7) Выглядит как решение проблемы точечной связности
...
.Проблема связности означает, что сигналы для квалиа должны сходиться на 1й точке.
...
Это можно назвать проблемой точечной связности.
