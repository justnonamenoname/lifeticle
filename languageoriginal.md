...
Принципиальная невозможность родиться второй раз - означает невозможность родиться и первый.
...
Зрительный образ включает в себя информацию о точках зрительного образа.
Невозможно, чтобы информация в явлении была, но явления не существовало (речь о самой информации, а не о её содержании).  
Возможность вывести законы квантовой механики также отменяют предположении о не существовании квалиа (об интерпретации квантовой механики в разделе связи квалиа с мозгом).  
...
Это может означать, что у точки изображения имеется параметр размера, и имеет точка форму круга, либо другой способ формирования размера.
...
можно предположить противоположный параметр как спин, или как положительный или отрицательный ион.
...
Т.к. волновая функция должна коллапсировать только в момент, когда кадр сознания уже готов, то времени должно хватать на составление этой волновой функции.
...
другая причинно-следственная связь, события в виде коллапс, дополнительные параметры в видео гильбертова пространства, фундаментальность.  
...
Минимальный размер/единица квалиа - по размеру и силе.
...
Если не сохранить свой лайфтикл, то при поглощении земли солнцем можно остаться в солнце на миллиарды лет, а там неизвестный уровень случайных квалиа, возможно адовый.
...
Совмещение обратного влияния квалиа от двух лайфтиклов в одном коллапсе возможно было бы конфликтным.
