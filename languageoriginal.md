...
Ты в мозгу - частица что чувствует - т.н. наблюдатель/лайфтикл.
Мозг не является неделимым объектом, он состоит из неделимых частиц.
Чем можно являться в мозгу? Ответ - носителем сознания можно выбрать только одну неделимую частицу.
Нельзя выбрать несколько, т.к. они являются отдельными частицами.
...
Если лайфтикла нет, то нет того, что ощущает, 
...
Можно взять его из умирающего организма и поместить в другой, и для него - он продолжит свою жизнь.
...
Но есть огромная проблема - возможна боль и несчастья.
...
Даже если в галактике жизнь на другой планете не зародилась, может быть она зародилась в соседней, и через миллионы лет нашу галактику заполонят роботы.
...
В связи с тем, что после смерти вокруг лайфтикла нет такой электронной активности как в мозгу,
...
И человека при смерти надо крионировать, а не закапывать или сжигать, выкидывая его основную частицу где попало.
...
Если разрушение клеток мозга - это лишь их перемещение, то теоретически их можно переместить назад.
...
8) Если нет сухого льда необходимо организм поместить в холодильник ниже 0 градусов с максимально низкой температурой.
...
1) Изучение куда сходятся потоки для квалиа - они должны сходиться на одной точке методом генерации квалиа (предполагаемые методы в разделе связи квалиа с мозгом),
...
что мозг состоит из неделимых частиц и то, что носитель сознания находится где-то в мозгу (о необходимости носителя сознания в разделе фундаментальности).
...
Не фундаментально - возможно объяснение другими явлениями.  
Фундаментально - невозможно объяснить другими явлениями.  
...
При доказательстве не фундаментальности достаточно примера явления, из которой квалиа может состоять.
...
Сказать, что квалиа как отдельного явления не существует и основано на информации, эквивалентно по смыслу сказать, что монитор находится в процессоре.  
Сказать, что квалиа не существует, это сказать, что у человека нет восприятия изображения глаза, нет звука, нет боли, это мёртвое состояние, 
а организм действует без феноменального сознания.  
...
Отсюда и возникли "Трудная проблема сознания"/"Разрыв в объяснении" - попытка одно явление объяснить другим явлением.
...
Предполагаемые возможные структурные методы создания квалиа:
...
Проблемой выступает добавление поля и должен определяться его размер.
...
цепочку [Симуляция процесса в мозгу - генератор - квалиа]  
...
Возможно, что в состоянии смерти вокруг лайфтикла может быть активность, вызывающая квалиа, и будучи мёртвым, что-то чувствуешь и время не проходит моментально.
...
Такого робота легко создать, а миллионы таких роботов, непонятно, возможно ли уничтожить.
...
то не будет причины по которой смогла бы развиваться положительная по ощущениям структура без влияния лайфтикла на окружение,
это значит лайфтикл как-то может влиять на окружение (не только передавать информацию, что не обязательно могло бы влиять).
Раз лайфтикл влияет на организм, то он влияет и на эволюцию, и эволюция уже включает результат обратного влияния, также как включает и боль.
...
Возможно в статусе смерти будет указываться: центральная частица/носитель сознания/lifeticle: сохранена/утеряна.
...
Более сложно чтобы лайфтикл оказался в мозгу при эволюционном развитии мозга, но если бы он был в атоме, то эта дополнительная сложность не нужна.
...
Такой же вопрос относится к началу Вселенной в первые сотни тысяч лет.
...
И у лайфтикла есть обратное влияние.
...
Если момент начала существования лайфтикла, не момент рождения и не во время беременности, то каким моментом это может быть?
...
Каким образом получается, что есть ещё другие лайфтиклы с такими же свойствами? Означает ли, что у них что-то общее, общий парадокс? Но это отдельные частицы.
