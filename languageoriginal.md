...
1) Изучение куда сходятся потоки для квалиа, и они должны сходиться на 1 точке методом генерации квалиа (предполагаемые методы в след. главах),
...
3) Решение проблемы точечного связывания (о проблеме в след. главах)
4) Соответствие решения проблемы скорости времени (о проблеме в след. главах)
...
3) Похожесть информационного перехода с точки с радиусом на круг (о переходе в след. главах)
