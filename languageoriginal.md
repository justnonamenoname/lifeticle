...
Lifeticle - частица, являющаяся субъектом, так называемым наблюдателем в мозгу, с функциями:
...
Если от организма, будучи ребёнком, ничего не осталось, то он разрушен и умер, а сейчас уже другой.
...
Значит из частиц что-то остаётся, и какая та частица - и есть центральная/основная в мозгу - и она и является т.н. наблюдателем/лайфтиклом.
...
Это означает, что в мозге можно заменить какую угодно частицу на идентичную - и не будет разницы,
...
Ретикулярная формация является эволюционно древнейшим отделом мозга.
...
Если лайфтикла нет, то нет сущности что ощущает, 
не на чём сходиться целостно формируемой картине мира (квалиа изображения глаза и других органов чувств), создаётся проблема связывания.
...
Возможность родиться первый раз - означает возможность родиться и второй.
...
Однако, разрушение представляет из себя лишь не одномоментное перемещение атомов и теоретически обратимо.
...
Если в религиозном смысле есть летающие ангелы, что следят за этим, и что будет, если они не проследят? Но нет причины считать, что подобные ангелы существуют.
...
Что сводит такой вопрос в никуда и делает его бессмысленным.
...
Мир может скатиться в непобедимый фашизм.
Или роботы уничтожат мир и построят ад, случайно или кем-то специально.
Такие роботы могут неограниченно выращивать людей в инкубаторах и причинять им боль.
На планете уже есть виды эволюционирующие друг к другу - один вид изменяется чтобы эффективнее съесть другой, другой вид изменяется, чтобы защититься от съедения.
Это ад.
...
Остановить страдания у других видов, остановить ад у тех у которых он есть, чтобы родиться другим видом было не страшно.
Даже если человечество вымрет, есть другие виды, что могут развиться за миллионы лет. Исключение - полное уничтожение условий жизни на планете.
...
Это миллиарды лет, если роботы не перенесутся на другую планету при уничтожении этой солнцем, либо до распада материи или до цикла сжатия вселенной, если вселенная циклична.

Возможно, в будущем будет создана организация, следящая за защитой от скатывания в несвободный ад.
Можно построить виртуальную реальность, где в базовой реальности люди будут замкнуты без возможности выбраться, а в виртуальной реальности свобода и рай.
...
Если физика позволяет сверхсветовой двигатель, скорей всего таких роботов ещё нет, иначе они были бы уже здесь.
...
И при жизни, скорость течения времени может ощущаться медленнее или быстрее, а во сне без сновидений, время проходить моментально.
...
При этом нет момента, когда можно было бы уже сказать, что ситуация замкнулась и должно произойти какое-то изменение.
...
Лишь возможные открытия в физике могут исключить вариант "нулевой вечности", и то если у Вселенной этапы расширения и сжатия цикличны, и физика позволяет это обнаружить.
...
Если оглянуться назад - 200 лет назад технологии были гораздо менее развиты, а 500 лет назад это разница ещё сильнее.
...
Целостность мозга, возможно, может быть вторична.
...
Только того, что они не имеют никакого отношения к телескопам, и нет никаких призывов от них изучать мир с их помощью, достаточно для того чтобы умножить их мнение на ноль.
...
И физики будущего следующие сотни лет, возможно, смогут приблизиться к загадке сознания и вопроса центральной частицы, и ответят на вопросы, задаваемые в теории.
...
Организм человека - это то, из чего он состоит, и оно было и до рождения, и не исчезает после смерти.
...
Сначала выживание, а после изучение.
...
4) Страховка, когда человек платит определённую сумму в месяц на случай необходимости. Такое уже где-то используется
5) Пожертвования

Это не техническая и не только экономическая проблема, проблема ещё и в популярности, на что и направлена статья.
...
1) Завернуть организм в ткань. Поместить в полиэтиленовый мешок.
...
5) Гранулы сухого льда необходимо меньше, чтобы не оказывать давление на организм.
6) Окружить организм сухим льдом в контейнере.
7) Проверять сухой лёд раз в день, при необходимости добавлять.
8) Если нет сухого льда необходимо организм поместить в холодильник ниже 0 градусов.
...
1) Изучение куда сходятся потоки для квалиа, и они должны сходиться на одной точке методом генерации квалиа (предполагаемые методы в разделе связи квалиа с мозгом),
...
что частицы при смерти исчезают; если мы находимся в виртуальной реальности; что есть момент смерти и не обнаруженные ангелы в самом деле прилетают.

**Теория Orch OR**

Квантовая теория Orch OR (оркестровая объективная редукция) Пенроуза-Хамероффа делает некоторые соответствия теории лайфтикла:
1) То, что феноменальное сознание не находится в нейронах
...
Электромагнитная теория CEMI делает некоторые соответствия теории лайфтикла:
1) То, что феноменальное сознание не находится в нейронах
...
Свойства эмерджентности можно получить моделируя, например: зная свойства молекулы воды, можно получить свойства воды моделируя множество молекул.  
Проблема точечного связывания требует отдельного закона, что также указывает на фундаментальность квалиа (о проблеме в разделе идей по квалиа).  
...
Заявление о том, что квалиа как отдельной сущности не существует и основано на информации, эквивалентно заявлению о том, что монитор находится в процессоре.  
Заявление о том, что квалиа не существует, это заявление что у человека нет восприятия изображения глаза, нет звука, нет боли, это мёртвое состояние, 
а организм действует автоматически.  
...
Сказать, что частица лайфтикл, т.н. наблюдатель, являющаяся носителем сознания, не может существовать, эквивалентно тому, 
...
Квалиа имеют параметр расположения, у квалиа есть пространство, где в центре находится носитель сознания.  
...
Достаточно для того, чтобы построить реальность, кроме носителей сознания и квалиа.
Отсюда и возникли "Трудная проблема сознания"/"Разрыв в объяснении" - попытка одну сущность объяснить другой сущностью.
...
1) Функциональная часть мозга без квалиа/феноменального сознания - "Лёгкая проблема сознания"/"Сознание доступа"
...
У изображения от глаза есть левая часть и правая, и вроде как они отдельно, но если бы это было так, пришли бы опять к проблеме связывания.
Это можно назвать проблемой точечного связывания.
Проблема относится как к связи квалиа между собой, так и связи с лайфтиклом.
...
У раков-богомолов есть два ветвистых больших фасеточных глаза. Эти глаза имеют 16 типов фоторецепторов (в то время как у человека их 2: колбочки и палочки).
Раки-богомолы также способны различать инфракрасный и ультрафиолетовый цвета и видеть линейную и круговую поляризацию.
Создаётся вопрос - эти 16 типов фоторецепторов видят цвет в том же спектре как человек (смесь из 3-х цветов синий красный зелёный) или ему доступны другие типы ощущения цветов?
Кроме самого цвета, в его ощущении есть ещё яркость и расстояние. Это задаёт вопрос, какие вообще типы ощущений доступны кроме основных органов.
...
Изучение работы квалиа и лайфтикла может позволить рассматривать мораль/этику с позиции науки, 
...
Возможно, что в состоянии смерти вокруг лайфтикла может быть активность, вызывающая квалиа, то будучи мёртвым, что-то чувствуешь и время не проходит моментально.
...
Вариант может не сработать при цикличной Вселенной, т.к. бесконечного расширения нет и вокруг лайфтикла может оставаться активность, вызывающая квалиа.
...
Предполагаемые возможные структурные методы создания квалиа, и у них свои недостатки:
1) Можно представить, что электрическая активность рядом с лайфтиклом является генератором. 
У изображения глаза по количеству информации, мало того, что огромный размер в мегапиксели и мегабайты, но есть ещё глубина и яркость.
...
2) Частицы квантово связаны между собой, и электрическая активность вокруг них создают в них квалиа, что и чувствует лайфтикл связанный с ними.
Это создаёт проблему расстояния.
Метод соответствует Orch OR.
...
Это может означать, что у точки изображения есть параметр размера, и имеет точка форму круга, либо другой способ формирования объёма.
...
Если бы кадры изображения и звука были отдельно, это приводило бы к морганию и изображения и звука.
...
Изучив информацию в мозге о квалиа и процесс у которого не получается объяснить квалиа другой сущностью и делающим вывод о фундаментальности,
...
Если стукнуть по ноге, создаётся ощущение боли, и она чувствуется на расстоянии от мозга.
...
Можно предположить концепцию, что они располагаются на атомарном уровне, например: расстояние в 1 метр - это 1 тысячная атома, а ощущение на расстоянии в километр - размер атома.
В этом случае дальше чем километр что-либо ощущать нельзя.
Т.е. квалиа имеют вполне реальное расположение, но размер этого очень маленький, квалиа размером на уровне молекулы.
При взрослении объекты ощущаются другим размером, и даже если вокруг лайфтикла есть собственная область пространства и размеры ощущений больше,
...
Как это связано с пространством квалиа?
...
Если квалиа выставляется в соответствии с мозгом, то угол поля квалиа соответствует мозгу, если не в соответствии, то угол поля не соответствует мозгу.
...
Одного копирующего робота достаточно чтобы за миллионы лет уничтожить жизнь, и чтобы он не позволил жизни появиться.
...
т.к. и в том и другом случае жизнь уже не может существовать.
...
Не существует варианта, когда роботы уничтожаются, но нового эволюционного пути нет.
...
Если бы лайфтикл не мог передавать информацию в мир, человек не мог бы сказать о существовании квалиа.
...
это значит лайфтикл как-то может влиять на мир (не только передавать информацию, что не могло бы влиять).
Эволюция уже включает результат обратного влияния, как включает и боль.
...
Даже если между известным явлением и обратным влиянием есть не открытое явление, 
его открытие переместит его нахождение в цепочке [известное физическое явление - обратное влияние] со стороны обратного влияния в другую сторону.
...
Нарушение внутренней причинно-следственной связи у существования лайфтикла, если бы была внешняя причина для создания, это бы подразумевало, что лайфтикл уже есть,
...
Цель создания лайфтикла и есть смысл жизни, но раз существование лайфтикла - это парадокс, то смысл жизни в парадоксе.
...
Более сложно чтобы лайфтикл оказался в мозгу при эволюционном развитии мозга, но тогда эта дополнительная сложность не нужна.
...
Идея более сложна структурно, в том числе эволюционно и с учётом влияния лайфтикла и нет причин для такой сложности, идея эволюционно маложизнеспособна.

**Проблема неделимой структурности**

Изображение может исчезать, значит оно не является частью лайфтикла, но является каким-то внешним функционалом.
...
Эта проблема присутствует и у элементарных частиц, у электрона есть свойства импульса (направление и скорость), заряд, спин, взаимодействие с другими частицами и т.д.
...
Возможно это фундаментальное требование, иначе реальность бы не строилась.
...
Они выполняют действия, но феноменальное сознание никаких подобных действий не выполняет.
...
В завершённой физической теории должно быть явление квалиа.
И либо должна быть найдена частица лайфтикл, либо свойство квалиа определено у элементарной частицы.
...
но это также бы означало, что прошло уже бесконечно количество времени, что невозможно.
...
Есть предположение физиков, что в обратном отсчёте времени, само время в начале круговое и оно так может быть бесконечным, оно заворачивается на само себя,
...
Проблема такой идеи в том, что у Вселенной должна быть концовка, в которой вдобавок ещё есть какая-то функция переноса лайфтикла назад во времени.

**Количество лайфтиклов**

Ограничено ли количество лайфтиклов в реальности? Диаметр Вселенной как минимум в 40 раз больше наблюдаемой Вселенной, и неизвестно, бесконечна ли она.
...
это эквивалентно варианту, что у атома есть своё внутреннее пространство размером с километр.
...
А вариант, когда лайфтикл одновременно находится в двух или нескольких мирах и живёт параллельно в параллельных мирах - бессмысленен.
...
что требует, чтобы при разделении лайфтиклы уходили только в 1 мир, либо что интерпретация неверна.
...
Если поле квалиа трёхмерно, то оно плохо связывается с теорией Вольфрама:
