...
Если от организма, будучи ребёнком, ничего не осталось, то он разрушен и умер, а в настоящее время уже другой.
...
При доказательстве не фундаментальности достаточно примера явления, из которой квалиа может состоять, т.е. стартовая точка фундаментальность.  
...
Вопрос о существовании других Вселенных эквивалентен вопросу есть ли ещё пространство с материей где-то ещё, если её размер ограничен.
