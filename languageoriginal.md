...
Это означает что квалиа не может стоять за не случайными процессами и связано со случайными квантовыми процессами.  
2 возможных варианта обратного влияния на случайные квантовые процессы:
1) Не в момент ощущения позже
2) В момент самого ощущения, можно предположить, что в случае отрицательного квалиа, чем сильнее боль, тем сильнее влияние на случайные квантовые процессы.

Физики могут начать предполагать, каким квантовыми явлением может быть обратное влияние.
