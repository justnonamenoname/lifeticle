...
У других квалиа также присутствует параметр размера. Размер и координата квалиа - параметры одного порядка.
...
В проблеме точечного связывается присутствует несколько аспектов:
1) Зрительный образ состоит из миллионов точек, это результат
2) 1 частица не может хранить много разной информации
...
А раз единство сознания исходит из единства волновой функции квантово запутанных частиц, то одна из причин религии - это неверное объяснение явления квантовой запутанности.
...
1) Магическое дальнодействие нарушающее принцип локальности и специальную теорию относительности
...
4) Либо какая-то определённая точка, что уже плохо совмещается с идеей распределённой информации
5) Сканирование либо приводит к варианту передачи информации в мозг, который мозг анализирует и отправляет обратно
6) Либо магическое дальнодействие само анализирует информацию
7) Необходима настройка дальности
8) Сканированию необходимо определять структуры, чтобы в часть сознания не попал другой мозг, это требует анализ структуры собственного мозга на возможность передачи данных
9) Такое магическое дальнодействие не имело бы физического влияния на мозг, а с влиянием было бы магическим нарушением причинно-следственной связи
10) Доказать такое невозможно
...
1) Мозг не разделяется на 2 части, разделяется мост между полушариями, полушария связаны через другие отделы мозга
2) Выводы о результатах делалось до разделения сознания на сознание доступа и феноменальное сознание
...
Попытки объяснить идентичность сознания непрерывностью процесса сталкивается с проблемами:
...
4) Плохая совместимость идея с наркозом
5) Проблема с теми нейронами, которые периодически заменяются
...
Две частицы могут находиться в одном квантовом состоянии и приводят к невозможности к их различить.
