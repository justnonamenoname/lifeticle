...
Значит из частиц что-то остаётся, и какая та -  центральная/основная в мозге, и она и является т.н. наблюдателем (лайфтиклом).
...
кардинально отличающееся от остального мира, и это и является жизнью - живая частица (life+particle - lifeticle).
...
Это значит, что физического момента смерти не существует.
...
На планете существуют есть виды эволюционирующие друг к другу - один вид изменяется чтобы эффективнее съесть другой, другой вид изменяется, чтобы защититься от съедения.
Это ад.
...
Даже если человечество вымрет, существуют другие виды, что могут развиться за миллионы лет. Исключение - полное уничтожение условий жизни на планете.
...
Если у тёмной энергии и Вселенной существуют циклы расширения/сжатия - следующая жизнь неизбежно начнётся.
...
Заморозить человека стоит ~4 миллиона рублей, животное ~1 млн руб., может показаться, что это слишком дорого, однако в крупных городах полно людей, у которых имеются такие деньги.
Если у человека нет денег, возможны способы решения:
...
К вопросу о фундаментальности квалиа и его уникальности как явления возможны 2 варианта.  
...
Из невозможности объяснения другими явлениями и возникли "Трудная проблема сознания"/"Разрыв в объяснении" - попытка одно явление объяснить другим явлением.
...
Такой переход присутствует в электромагнитной теории сознания CEMI, которая соответствует 3 методу генерации квалиа.
...
Кроме самого цвета, в его ощущении существует ещё яркость и расстояние. Это задаёт вопрос, какие вообще типы ощущений доступны кроме основных органов.
...
При взрослении объекты ощущаются другим размером, и даже если вокруг лайфтикла существует собственная область пространства и размеры ощущений больше,
...
Не существует варианта, когда роботы уничтожаются, но нового эволюционного пути не происходит.
...
При этом существуют направления жизни - счастье/положительные квалиа, боль/негативные квалиа и "нулевая вечность".
