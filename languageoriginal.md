...
Вопрос поможет уточнить какая обратная информация идёт от лайфтикла при обратном влиянии.
...
Возможно квалиа вызывает не электрическая активность, а окружающие молекулы, глаз может отличить разницу 100 и 200 кадров в секунду, скорости электрохимического взаимодействия достаточно.
Это возможно только при 2 и 3 структурном методе квалиа.
Генерируемое изображение - по количеству информации - это мегабайты в секунду, и несмотря на то, что информация в мозгу передаётся по нейронам электрически - сами квалиа могут вызываться не ими.
