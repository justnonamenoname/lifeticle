...
отсутствие которого приводит к проблеме связывания. Разделение квалиа по разным отделам мозга не было обнаружено.
Функциональная часть мозга относится "Лёгкой проблеме сознания"/"Сознанию доступа".  
...
Отход от теории лайфтикла приводит к противоречиям и отсутствию ответов на эти вопросы.
...
3) Частицы квантово связаны между собой, и электрическая активность создаёт в них квалиа, что и ощущает лайфтикл связанный с ними.
...
А добавление к нему влияния привело бы к нарушению закона сохранения энергии и причинно-следственной связи.
...
В связи с тем, что 1 частица не может хранить много разной информации, 
глубина зрительного образа требовала бы множество частиц глубины, а расстояние объёма было бы ограничено и возможно имела бы заметные шаги изменений,
частицы, содержащие образ при запутывании, были бы путями, по которым перемещаются данные.
Структуры похожей на способную таким образом содержать зрительный образ в мозге не было найдено.
Расстояния и другие частицы между запутанными частицами приводили бы к пустотам между точками зрительного образа.  
В случае расположения частиц рядом друг с другом сеткой - пути, по которым перемещаются данные, были бы не изолированы.
Вариант, когда точки разной глубины настраиваются в одних местах, более стабилен структурно, так для изображения разной глубины используется та же сетка.
Лайфтикл необходимо было бы держать под углом к пространству квалиа для соответствия координат квалиа.  
...
Это соответствует тому, что в Orch OR форма генератора квалиа не соответствует координатам квалиа.
В связи с одномоментностью кадров, частиц, участвующих в генерации волновой функции, должно быть не меньше, чем количество разных типов квалиа.
...
то она разная в разные моменты, как по типу, так и по количеству квалиа, а значит и участвующих частиц.
...
Предварительная общая формула квалиа  
|ψ<sub>qualia</sub>> = i,j,...∑cij...(|<sub>зрение</sub>i>⊗|<sub>звук</sub>j>⊗...)
