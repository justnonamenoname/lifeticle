...
5) Решение информационного перехода с точки с радиусом на круг (о проблеме в разделе связи квалиа с мозгом)
...
Изучение схождения сигналов для квалиа поможет разобраться.
...
Переход может решить волновая функция и теория CEMI, которая соответствует 3 методу генерации квалиа.
