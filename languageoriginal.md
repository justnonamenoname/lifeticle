# Lifeticle | ЛТ квантовая теория феноменального сознания | Выживание
...
2) Если до перемещения в криоцентр не больше нескольких дней, организм необходимо поместить в холодильник не ниже 1 градуса, чтобы не вызвать рост кристаллов льда.
...
8) Обратное влияние квалиа связано с квантовыми законами, это само по себе указывает на частицу
9) Проблема точечного связывания решается квантовыми процессами
10) Переход с точки и радиусом к кругу способны решить квантовые процессы
...
Генератор передаёт информацию на квантовый уровень.  
