...
The minimum size of qualia in an image - the smaller the size of the point in the image, the more points are needed to generate the image.
...
4) The spin influences the emitted radiation, photons 0 this is the particle's influence on the world
...
Is it possible to create qualia of a volumetric image with multiple layers? One object is visible behind another, and they do not overlap.
